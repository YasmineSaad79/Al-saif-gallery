    ...
    final pillars = [
      ...
      _Pillar(
        ...
        paragraphs: isArabic ? [
          ...
          'Our logistics infrastructure supports this network: two central warehouses in Riyadh with a combined area exceeding [50,000] m² (pending client confirmation), a Jeddah fulfillment center, and qualified logistics partners operating to defined service level agreements. Replenishment discipline reduces stockouts in peak seasons; centralized inventory management enables faster turns. This is operational excellence in service of customer trust.',
        ],
      ),
      _Pillar(
