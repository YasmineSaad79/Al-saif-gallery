    ...
    final pillars = [
      ...
      _Pillar(
        ...
        paragraphs: isArabic ? [
          ...
          'In 2025, our digital channels contributed SAR 549.94 million in revenue, 11.4% of the total, up 37% for the full year. Our app has 900,000+ downloads and a 4.2-star rating, serving over 15,000 products. But the number that matters most is not the digital revenue percentage, it is the integration depth. Buy-and-collect allows fulfillment from the showroom network. Returns and warranty claims processed at physical locations. Unified payment options including installment and smart device payment across both channels.',
