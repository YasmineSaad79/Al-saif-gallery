...
class SearchData {
  static const List<SearchResult> items = [
    ...
    SearchResult(
      ...
      route: '/about-us', categoryEn: 'About', categoryAr: 'من نحن',
    ),
    SearchResult(
    ...
    SearchResult(
      ...
      route: '/strategy-operations', categoryEn: 'Strategy', categoryAr: 'الاستراتيجية',
    ),
    SearchResult(
    ...
    SearchResult(
      ...
      route: '/investors-governance', categoryEn: 'Investors', categoryAr: 'المستثمرون',
    ),
    SearchResult(
    ...
    SearchResult(
      ...
      route: '/news-careers', categoryEn: 'News', categoryAr: 'الأخبار',
    ),
    SearchResult(
    ...
    SearchResult(
      ...
      route: '/investors-governance', categoryEn: 'Contact', categoryAr: 'تواصل معنا',
    ),
  ];
